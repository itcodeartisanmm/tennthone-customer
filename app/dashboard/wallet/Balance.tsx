...
import { Button, Card, CardBody, Popover, PopoverContent, PopoverTrigger, Tabs, Tab } from '@heroui/react'
import { EyeFilledIcon, EyeSlashFilledIcon, LockedIcon, InfoIcon, TaxesIcon } from '@/components/icons'
...
const Balance = ({ dashboardData, setDashboardData }: {
